...
const translations = {
    ...
    ar: {
        ...
        'footer-description': 'نقدم نكهات لا تُنسى ووقت مميز',
        'footer-contact': 'اتصل بنا',
        'footer-address': 'KRO st، دهوك، كردستان',
    ...
    ku: {
        ...
        'footer-description': 'تامی نەبیراو و کاتی جوان پێشکەش دەکەین',
        'footer-contact': 'پەیوەندی',
        'footer-address': 'KRO st، دهۆک، کوردستان',
